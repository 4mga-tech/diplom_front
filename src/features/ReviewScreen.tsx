...
const REVIEW_SET: ReviewQuestion[] = [
  {
    ...
    prompt: 'What is the best English meaning of "Баярлалаа"',
    helper: "Choose the closest translation.",
    options: ["Goodbye", "Thank you", "Please", "Tomorrow"],
    correctAnswer: "Thank you",
    explanation: '"Баярлалаа" is the standard way to say "Thank you."',
    xpReward: 8,
  },
  {
    id: "review-2",
    type: "true_false",
    prompt: '"Тийм" means "Yes".',
    helper: "Decide whether the statement is true.",
    options: ["True", "False"],
    correctAnswer: "True",
    explanation: '"Тийм" is used to say "Yes."',
    xpReward: 6,
  },
  {
    id: "review-3",
    ...
    options: ["Үгүй", "Тийм Байх ??", "Баярлалаа", "Сайн"],
    correctAnswer: "Үгүй",
    explanation: '"Үгүй" means "No."',
    xpReward: 8,
  },
  {
    id: "review-4",
    ...
    options: ["Мөнгө", "Тасалбар", "За", "Бип"],
    correctAnswer: "Тасалбар",
    explanation: '"Тасалбар" is the word for a ticket.',
    xpReward: 10,
  },
  {
    id: "review-5",
    ...
    correctAnswer: "Би өглөө цай уудаг.",
    explanation:
  ...
  },
  {
    id: "review-6",
    type: "true_false",
    prompt: 'The phrase "Сайн уу юу байна" is used as a greeting.',
    helper: "Think about common conversation starters.",
    options: ["True", "False"],
    correctAnswer: "True",
    explanation:
      '"Сайн уу юу байна" is a greeting similar to "Hello/How are you?"',
    xpReward: 8,
  },
];
